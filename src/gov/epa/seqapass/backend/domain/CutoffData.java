...
//This is the original cutoff data object used for version 2.0 of SeqAPASS
public class CutoffData implements Serializable {
	...
	public CutoffData(List<Double> xData, List<Double> yData, List<Double> cutoffValues, List<Integer> maxCritLoc, List<Integer> minCritLoc, List<Integer> infLoc) {
		this.xData = xData;
		this.yData = yData;
